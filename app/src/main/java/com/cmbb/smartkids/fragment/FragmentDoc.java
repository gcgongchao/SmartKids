 ...
 * Created by N.Sun
 */
public class FragmentDoc extends BaseFragment implements LoaderManager.LoaderCallbacks {

    private static final String TAG = FragmentDoc.class.getSimpleName();
