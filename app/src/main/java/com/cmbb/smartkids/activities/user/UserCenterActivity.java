...
import com.cmbb.smartkids.base.ui.notboring.AlphaForegroundColorSpan;
import com.cmbb.smartkids.base.ui.notboring.KenBurnsView;
...
public class UserCenterActivity extends BaseNoCompatActivity {
    ...
    protected void init() {
        ...
        mHeaderPicture.setResourceIds(R.drawable.splash_backgroud_four, R.drawable.splash_backgroud_six);
        mHeaderLogo = (ImageView) findViewById(R.id.header_logo);

        mActionBarTitleColor = getResources().getColor(R.color.white);

        mSpannableString = new SpannableString("SmartKids");
    ...
    private void setupListView() {
        ...
        mPlaceHolderView = getLayoutInflater().inflate(R.layout.notboring_view_header_placeholder, mListView, false);
