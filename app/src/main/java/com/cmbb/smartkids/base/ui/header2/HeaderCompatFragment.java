package com.cmbb.smartkids.base.ui.header2;
 ...
 * Created by N.Sun
 */
public abstract  class HeaderCompatFragment extends Fragment {

    private static final String TAG = HeaderCompatFragment.class.getSimpleName();
